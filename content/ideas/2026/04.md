...
- Event sourcing/event log-based infrastructure management; replace the declare-state structure of IaC with a declare-suggested-changes structure that is merged into an event log-based immutable record.
